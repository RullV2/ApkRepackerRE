...
public class SettingsFragment extends PreferenceFragmentCompat
        implements BaseBottomSheetDialogFragment.OnDismissListener,
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        prefs.edit()
                .putBoolean(
                        PreferenceKeys.KEY_AUTO_THEME,
                        Theme.getInstance(requireContext()).getThemeMode()
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        findPreference(PreferenceKeys.KEY_CHECK_FOR_UPDATE).setOnPreferenceClickListener(this);
        updateThemeSummary();
        mThemePref.setOnPreferenceClickListener(
                p -> {
        ...
        mAutoThemeSwitch.setOnPreferenceChangeListener(
                (preference, newValue) -> {
        ...
        mAutoThemePicker.setOnPreferenceClickListener(
                pref -> {
        ...
        mUseCustomKeySwitch.setOnPreferenceChangeListener(
                (preference, newValue) -> {
                    boolean value = (boolean) newValue;
                    if (value) {
    ...
    private void updateThemeSummary() {
        mThemePref.setSummary(
                Theme.getInstance(requireContext()).getConcreteTheme().getName(requireContext()));
    }
    ...
    public void onDisplayPreferenceDialog(Preference preference) {
        if (preference instanceof KeystorePreference) {
            KeystorePreferenceFragmentDialog keystorePreferenceFragmentDialog =
                    KeystorePreferenceFragmentDialog.newInstance(preference.getKey());
    ...
    public boolean onPreferenceClick(Preference preference) {
        ...
        switch (key) {
        case PreferenceKeys.KEY_CHECK_FOR_UPDATE:
       new UpdaterAssistant(getActivity(), true).checkForUpdates();
      return true;
